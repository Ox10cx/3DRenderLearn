...
public class Gesture {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if(mTwoFingerPointerId != INVALID_POINTER_ID) {
                        ...
                        mLastTouchX = x;
                        mLastTouchY = y;
                        NativeRenderScene.onSceneMove(dx, dy);
                    }
                    break;
                }
    ...
    class MyTapScrollListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap (MotionEvent event) {
            NativeRenderScene.onSceneDoubleTab();
            return true;
        }
        ...
        public boolean onScroll (MotionEvent e1, MotionEvent e2,
            ...
            if(mTwoFingerPointerId == INVALID_POINTER_ID) {
                NativeRenderScene.onSceneScroll(distanceX, distanceY, e2.getX(), e2.getY());
            }
            return true;
        }
    }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            NativeRenderScene.onSceneScale(detector.getScaleFactor());
            return true;
        }
    }

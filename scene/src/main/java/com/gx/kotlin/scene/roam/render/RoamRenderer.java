...
public abstract class RoamRenderer implements RoamRendererScheduler{
    ...
    public RoamRenderer(@NonNull Context context) {
    ...
    private native void nativeInitialize(RoamRenderer self, AssetManager assetManager, String path);

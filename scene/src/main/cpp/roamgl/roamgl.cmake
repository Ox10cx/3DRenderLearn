add_library(roamgl STATIC
        ...
        ${CMAKE_SOURCE_DIR}/roamgl/gfx/attribute.cpp
        ...
        ${CMAKE_SOURCE_DIR}/roamgl/tile/geometry_tile_data.cpp
)
...
target_include_directories(roamgl SYSTEM PUBLIC
        ...
        ${CMAKE_SOURCE_DIR}/roamgl/gfx
        ${CMAKE_SOURCE_DIR}/roamgl/programs
        ...
        ${CMAKE_SOURCE_DIR}/roamgl/tile
        ${CMAKE_SOURCE_DIR}/roamgl/style
)

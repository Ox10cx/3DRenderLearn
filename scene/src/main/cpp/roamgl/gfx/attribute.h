...
#ifndef ASSIMPDEMO_ATTRIBUTE_H
#define ASSIMPDEMO_ATTRIBUTE_H

#include "gfx/types.h"
#include "gfx/vertex_buffer.h"
#include "utils/type_list.h"
#include "utils/indexed_tuple.h"
...
#define ROAMGL_DEFINE_ATTRIBUTE(type_, n_, name_)                                                  \
    struct name_ {                                                                                 \
        using Type = ::roamgl::gfx::AttributeType<type_, n_>;                                        \
        static constexpr auto name() {                                                             \
            return #name_;                                                                         \
        }                                                                                          \
    }

#define ROAMGL_VERTEX_ALIGN __attribute__((aligned(4)))

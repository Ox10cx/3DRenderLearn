...
//    coordinates.push_back({2760, 3692});
//    coordinates.push_back({1848, 5176});
...
//    coordinates.push_back({1431, 10240});
    ...
    GLCall(glVertexAttribPointer(1, 4, GL_UNSIGNED_BYTE, GL_FALSE, vertices.bytes() / vertices.elements() , (void *) (4)));

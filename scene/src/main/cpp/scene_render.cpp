...
//
//
//int SceneRender::registerNativeMethods(JNIEnv *env, const char *className, JNINativeMethod *methods,
//                                       int numMethods) {
//
...
//}
//
//void SceneRender::registerNative(JNIEnv* env) {
...
//
//    // 相关JNI调用函数
//    if (!registerNativeMethods(env, Name(), methods,
//                               sizeof(methods) / sizeof(methods[0]))) {
//    }
//}
//
// jstring SceneRender::stringFromJNI(JNIEnv* env, jobject object) {
//    std::string hello = "Hello from C++";
//    return env->NewStringUTF(hello.c_str());
//}
//
//void SceneRender::OnDrawFrame(JNIEnv* env, jobject object) {
...
//}
//
//void SceneRender::OnSurfaceChanged(JNIEnv* env, jobject object, jint width, jint height) {
...
//}
//
//void SceneRender::onSurfaceCreated(JNIEnv* env, jobject object) {
...
//}
//
//void SceneRender::OnModelCreated(JNIEnv* env, jobject object, jobject assetManager, jstring path) {
//    LOGI("OnModelCreated");
//    gHelperObject = new JNIHelper(env, object, assetManager, path);
//    gAssimpObject = new AssimpModel();
//}
//
//void SceneRender::OnModelDeleted(JNIEnv* env, jobject object) {
...
//}
//
//void SceneRender::OnSceneMove(JNIEnv* env, jobject object, jfloat distanceX, jfloat distanceY) {
...
//}
//
//void SceneRender::OnSceneScroll(JNIEnv* env, jobject object, jfloat distanceX, jfloat distanceY, jfloat positionX, jfloat positionY) {
...
//}
//
//void SceneRender::OnSceneScale(JNIEnv* env, jobject object, jfloat scaleFactor) {
...
//}
//
//void SceneRender::OnSceneDoubleTab(JNIEnv* env, jobject object) {

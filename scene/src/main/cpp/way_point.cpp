...
namespace android {
    ...
    jni::Local<jni::Object<WayPoint>>
    WayPoint::New(jni::JNIEnv &env, const roamgl::WayPoint &wayPoint) {
        static auto &javaClass = jni::Class<WayPoint>::Singleton(env);
        static auto constructor = javaClass.GetConstructor<double, double>(env);
        return javaClass.New(env, constructor, wayPoint.getX(), wayPoint.getY());
    }

    roamgl::Point<double>
    WayPoint::getGeometry(jni::JNIEnv &env, const jni::Object<WayPoint> &wayPoint) {
        static auto &javaClass = jni::Class<WayPoint>::Singleton(env);
    ...
    roamgl::WayPoint
    WayPoint::getWayPoint(jni::JNIEnv &env, const jni::Object<WayPoint> &wayPoint) {
        auto point = WayPoint::getGeometry(env, wayPoint);
        return roamgl::WayPoint(point.x, point.y);
    }
